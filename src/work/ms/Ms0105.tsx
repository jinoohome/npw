...
const Ms0105 = ({ item, activeComp, leftMode, userInfo }: Props) => {
   ...
   const grid1Columns = [
      ...
      { header: "Q3", name: "q3", width: 250},
      { header: "A3", name: "a3", width: 120, align: "center"},
      { header: "Q1", name: "q1", width: 250},
      { header: "A1", name: "a1", width: 120, align: "center"},
      { header: "Q2", name: "q2", width: 250},
      { header: "A2", name: "a2", width: 120, align: "center"},
      { header: "Q4", name: "q4", width: 250},
      { header: "A4", name: "a4", width: 120, align: "center"},
      { header: "Q5", name: "q5", width: 250},
      { header: "A5", name: "a5", width: 250},
      { header: "Q6", name: "q6", width: 250},
      { header: "A6", name: "a6", width: 120},
      { header: "Q7", name: "q7", width: 250},
      { header: "A7", name: "a7", width: 120},
      { header: "Q8", name: "q8", width: 250},
