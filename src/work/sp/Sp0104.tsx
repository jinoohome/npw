...
//    }, [inputValues.zzMA0004]);
   ...
   const columns2 = [
      ...
      { header: "사업장", name: "bpNm", width: 250, sortable: true },
      { header: "사업장", name: "bpCd", width: 300,   hidden: true },
      { header: "작업명", name: "workCd", width: 250,  hidden: true },
      { header: "작업명", name: "workNm", width: 150, sortable: true },
      { header: "협력업체", name: "poBpCd", width: 300,  hidden: true },
      { header: "협력업체", name: "poBpNm", width: 150, sortable: true },
     // { header: "신청일자", name: "orderDt", width: 120, align: "center", }, // ORDER_DT: 발주 일자
      { header: "수주일자", name: "reqDt", width: 80, align: "center", sortable: true }, // REQ_DT: 요청 일자
      { header: "발주확정일자", name: "cfmDt", width: 100, align: "center", sortable: true }, // REQ_DT: 요청 일자
