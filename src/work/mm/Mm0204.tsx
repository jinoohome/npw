...
const Mm0204 = ({ item, activeComp, userInfo }: Props) => {
   ...
   const columns = [
      ...
      { header: "사용여부", name: "useYn", align: "center", sortable: true},
   ];
